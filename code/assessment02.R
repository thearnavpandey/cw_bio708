...
p10_2 <- pnorm(q = 10, mean = -5, sd = 3)
p0_2 <- pnorm(q = 0, mean = -5, sd = 3)

p0_to_10_2 <- p10_2 - p0_2
...
m <- aov(formula = count ~ spray,
         data = df_insect)

summary(m)

# Since p-value is <2e-16, which is less than 0.05, there is statistically 
# significant difference between spray groups.
